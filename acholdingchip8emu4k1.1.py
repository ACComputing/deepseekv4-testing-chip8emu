...
- Blue text / black background buttons
- Fixed ROM loading, I‑register quirks, and performance
"""
...
class Chip8:
    ...
    def load_rom(self, path):
        """Load ROM binary into memory and reset CPU state."""
        try:
    ...
    def cycle(self):
        ...
        if op == 0x00E0:  # CLS
            ...
            if nn == 0x07:  # LD Vx, DT
                ...
                self.i += x + 1  # original Chip-8 behavior
...
class Chip8GUI:
    ...
    def __init__(self, root):
        ...
        root.geometry("660x420")  # fits canvas + padding
        ...
        # Button colors (blue text on black background)
        self.btn_fg = "#3a86ff"      # bright blue
        self.btn_bg = "#000000"      # black
        self.btn_active_bg = "#1a1a1a"  # slightly lighter black when hovered
    ...
    def update_display(self):
        ...
        # Optimized: draw rectangles only for ON pixels
        for y in range(32):
            for x in range(64):
                if self.chip8.display[y * 64 + x]:
                    ...
                    x2 = x1 + self.SCALE
                    y2 = y1 + self.SCALE
                    self.canvas.create_rectangle(x1, y1, x2, y2, fill=self.pixel_on, outline="")
